...
public class ScriptUtilsTest {
	...
	public void testRead() {
		...
		maps[0] = ScriptUtils.toMap(
			"key1", "val1",
			"key2", "val2",
			"key3", "val3"
		);
		
		maps[1] = ScriptUtils.toMap(
			"key1", "val1b",
			"key2", "val2b",
			"key3", "val3b"
		);
		
		maps[2] = ScriptUtils.toMap(
			"key1", "val1c",
			"key2", "val2c",
			"key3", "val3c"
		);
	...
	public void testMapHasKeysReturnsTrue() {
		Map<String, String> map = ScriptUtils.toMap(
			"key1", "val1",
			"key2", "val2",
			"key3", "val3"
		);
	...
	public void testMap() {
		...
		Map<String, String> actual = ScriptUtils.toMap(
			"key1", "value1",
			"key2", "value2",
			"key3", "value3"
		);
