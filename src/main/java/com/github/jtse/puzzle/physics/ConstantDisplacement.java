...
/**
 * Collision algorithm where moving region displaces other regions by same change in x and y 
 * @author jtse
 *
 */
public class ConstantDisplacement implements Displacement {
	...
	/* (non-Javadoc)
	 * @see edu.binghamton.baby.puzzle.physics.Collision#apply(edu.binghamton.baby.puzzle.ogl.Region, int, int, edu.binghamton.baby.puzzle.ogl.Region[])
	 */
	@Override
